...
# Define cancer types
declare -a types=("normal" "metastatic_castration_resistant_prostate_cancer" "head_and_neck_squamous_cell_carcinoma" "meningioma" "low-grade_glioneuronal" "idh_wildtype_glioma" "idh_mutant_glioma" "brain_metastases" "hemangiopericytoma" "aml" "primary_prostate_cancer" "um_relapse" "um" "lfs_survivor" "lfs_previvor" "lfs_positive" "samll_cell_lung_cancer")

# Paths
config_file="/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run2/Machine_Learning/June_2024/Machine_learning_config_cancer_subytpe.csv"
output_dir="/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run2/Machine_Learning/June_2024/output_scripts_cancer_subtype"
slurm_dir="/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run2/Machine_Learning/June_2024/slurm_outputs_cancer_subtype"

...
outdir <- "Final Data May 2024/End_motifs/"
healthy_path <- "end_motifs/Healthy_data_20_600bp_frags/"

### Find paths
data_files <- list.files(path, "\\motifs.txt$", full.names = TRUE)
data_normal_files <- list.files(healthy_path, "\\motifs.txt$", full.names = TRUE)
...
ggsave(file.path(outdir, paste0("fragment_end_contexts_dnase1l3, May 2024, updated to all frags 5prime only, 3.pdf")), fig, width = 15, height = 8, dpi = 500, units = "in")
...
fig_fold_cancer
ggsave(file.path(outdir, paste("fragment_fold_change_all_cancers, May 2024, updated by Variance, all frags.pdf", sep = "")), fig_fold_cancer, width = 10, height = 4, dpi = 500, units = "in")
...
ggsave(file.path(outdir, paste("fragment_fold_change_all_cancers, May 2024, ordered by prop short insert size, all frags, narrower.pdf", sep = "")), fig_fold_cancer_ordered, width = 10, height = 3, dpi = 500, units = "in")
...
saveRDS(endmotif_matrix, file=file.path(outdir, paste0("End_motif_matrix_June2024.rds")))
saveRDS(metadata_df, file=file.path(outdir, paste0("Metadata_df_endmotif_June2024.rds")))

...
outdir <- "Final Data May 2024/Insert_size/"
...
saveRDS(insert_matrix_df, file = "Prop_insert_sizes_updated_June2024.rds")
write.table(insert_matrix_df, file = "Prop_insert_sizes_updated_June2024.txt", sep = "\t", quote = F, row.names = T)

...
directory <- "D:/Bratman Work/Data/cfMOS-DCC/Insert Size/75_250_QC"
ifelse(!dir.exists(directory),dir.create(directory),FALSE)
setwd(directory)

TCGE_cfDM_samples_only_fixed_Dory <- read.csv("D:/Bratman Work/Data/cfMOS-DCC/Insert Size/TCGE_cfDM_samples_only_fixed_after_QC_PE.csv")
insert_matrix_df_for_Althaf <- readRDS("D:/Bratman Work/Data/cfMOS-DCC/Insert Size/insert_matrix_df_for_Althaf.rds")
...
Vessies_Ref <- read_tsv("D:/Bratman Work/Scripts/cfmedipseq_pipeline/assets/fragment_score_refences/vessies_reference_set.txt", col_names = FALSE)
...
c("Normal" = '#33a02c', "Brain Cancer" = '#1f78b4', "Lung Cancer" = '#b2df8a', "Prostate Cancer" = '#a6cee3',
  ...
  "Blood Cancer" = '#fb9a99', "Eye Cancer" = '#fdbf6f',
...
ggsave(file.path(directory, paste("NMF fragmentation scores, March 2024 all frags.pdf", sep = "")), new_figure_plots, width = 11.5, height = 13, dpi = 1000, units = "in")

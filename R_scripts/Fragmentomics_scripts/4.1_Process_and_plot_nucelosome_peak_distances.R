...
outdir <- "Final Data May 2024/Nucelosome_peak/"
...
fig <- fig_nuc_peaks
ggsave(file.path(outdir, paste0("nucleosome_peaks_167bp cfMeDIP with pvalue, updated normals, May 2024, updated no pvalue, 3.pdf")), fig, width = 15, height = 7, units = "in", dpi = 500)
saveRDS(data_plot_filtered_reordered, file = "Dataframe for nucleosome peaks figure May 2024.rds")
...
saveRDS(metadata_df, file = "Metadata df June 2024 all samples.rds")
